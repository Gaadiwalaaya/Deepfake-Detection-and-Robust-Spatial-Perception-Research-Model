...
TRAIN_TRANSFORM = transforms.Compose([
    transforms.Resize((224, 224)),          # WildDeepfake 
...
class WildDeepfakeDataset(Dataset):
    ...
    def __init__(self, root: str, transform, use_forensics: bool = True,
        ...
        # Build flat list of (npy_path, label)
        self.samples = []
...
def build_dataloaders(celeb_path, wild_path, batch_size, val_split, num_workers):
    ...
    # Validation datasets (no augmentation, same files)
    ...
    # first batch, set NUM_WORKERS = 0 in config.py.
